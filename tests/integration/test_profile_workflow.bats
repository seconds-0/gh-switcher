...
@test "multiple SSH key suggestions prioritize username matches" {
    ...
    echo "work	v5	Work	work@company.com	$TEST_HOME/.ssh/old_work	github.com" >> "$GH_USER_PROFILES"
...
@test "email typo detection skips bot accounts" {
    ...
    echo "dependabot	v5	Bot	dependabot@github.com		github.com" >> "$GH_USER_PROFILES"
