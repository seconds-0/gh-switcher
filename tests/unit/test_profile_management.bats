...
@test "ghs show displays profile information" {
    ...
    echo "alice	v5	Alice Smith	alice@example.com	$TEST_HOME/.ssh/alice_key	github.com" >> "$GH_USER_PROFILES"
...
@test "ghs show works with user ID" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com		github.com" >> "$GH_USER_PROFILES"
...
@test "ghs show detects missing SSH key" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com	$TEST_HOME/.ssh/missing	github.com" >> "$GH_USER_PROFILES"
...
@test "ghs show finds alternative SSH keys" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com	$TEST_HOME/.ssh/old_key	github.com" >> "$GH_USER_PROFILES"
...
@test "ghs show detects permission issues" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com	$TEST_HOME/.ssh/alice_key	github.com" >> "$GH_USER_PROFILES"
    mkdir -p "$TEST_HOME/.ssh"
    touch "$TEST_HOME/.ssh/alice_key"
...
@test "ghs show detects email typo" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@github.com		github.com" >> "$GH_USER_PROFILES"
...
@test "ghs edit updates email" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	old@example.com		github.com" >> "$GH_USER_PROFILES"
...
@test "ghs edit updates name" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Old Name	alice@example.com		github.com" >> "$GH_USER_PROFILES"
...
@test "ghs edit removes SSH key with none" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com	/ssh/key	github.com" >> "$GH_USER_PROFILES"
...
@test "ghs show completes within reasonable time" {
    ...
    echo "perfuser	v5	Test	test@example.com		github.com" >> "$GH_USER_PROFILES"
...
@test "profile_has_issues detects SSH key problems" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice	v5	Alice	alice@example.com	/missing/key	github.com" >> "$GH_USER_PROFILES"
...
@test "profile_has_issues detects email typos" {
    ...
    echo "bob	v5	Bob	bob@github.com		github.com" >> "$GH_USER_PROFILES"
...
@test "profile_has_issues returns 1 for clean profile" {
    ...
    echo "clean	v5	Clean User	clean@example.com		github.com" >> "$GH_USER_PROFILES"
