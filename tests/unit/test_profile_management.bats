...
@test "ghs show displays profile information" {
    ...
    echo "alice|v3|Alice Smith|alice@example.com|$TEST_HOME/.ssh/alice_key" >> "$GH_USER_PROFILES"
...
@test "ghs show works with user ID" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@example.com|" >> "$GH_USER_PROFILES"
...
@test "ghs show detects missing SSH key" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@example.com|$TEST_HOME/.ssh/missing" >> "$GH_USER_PROFILES"
...
@test "ghs show finds alternative SSH keys" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@example.com|$TEST_HOME/.ssh/old_key" >> "$GH_USER_PROFILES"
...
@test "ghs show detects permission issues" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@example.com|$TEST_HOME/.ssh/alice_key" >> "$GH_USER_PROFILES"
    mkdir -p "$TEST_HOME/.ssh"
    touch "$TEST_HOME/.ssh/alice_key"
...
@test "ghs show detects email typo" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@github.com|" >> "$GH_USER_PROFILES"
...
@test "ghs edit updates email" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|old@example.com|" >> "$GH_USER_PROFILES"
...
@test "ghs edit updates name" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Old Name|alice@example.com|" >> "$GH_USER_PROFILES"
...
@test "ghs edit removes SSH key with none" {
    echo "alice" >> "$GH_USERS_CONFIG"
    echo "alice|v3|Alice|alice@example.com|/ssh/key" >> "$GH_USER_PROFILES"
...
@test "ghs show completes within reasonable time" {
    ...
    echo "perfuser|v3|Test|test@example.com|" >> "$GH_USER_PROFILES"
